...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		List<String> tokenizedwords = getTokens(pattern);
	    return tokenizedwords.size();
	}
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		String pattern = "[^!.?]+";
		List<String> tokenizedsentences = getTokens(pattern);
        return tokenizedsentences.size();
	}
	...
	public int getNumSyllables()
	{
		...
		String pattern = "[A-Za-z]+";
		List<String> tokenizedpattern = getTokens(pattern);
		int numsyllables = 0;
		for(int i = 0; i < tokenizedpattern.size(); i++) {
			String lowercase = tokenizedpattern.get(i).toLowerCase();
